...
--3. which are the top 5 products with the highest average reviews rating?
...
--5. do subscribed customers spend more? compare average spend and totl revenue between subscribers and non-subscribers.
...
--7. segement customers into New, returning, and loyal based on their total number of previous purchaases, and show the count of each segment.
